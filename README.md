...
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/SK-TTS)](https://pypi.org/project/SK-TTS/)
[![License](<https://img.shields.io/badge/License-MPL%202.0-brightgreen.svg>)](https://opensource.org/licenses/MPL-2.0)
[![PyPI version](https://badge.fury.io/py/SK-TTS.svg)](https://pypi.org/project/SK-TTS/)
[![Downloads](https://pepy.tech/badge/SK-TTS)](https://pepy.tech/project/SK-TTS)
...
[![Docs](<https://readthedocs.org/projects/SK-TTS/badge/?version=latest&style=plastic>)](https://SK-TTS.readthedocs.io/en/latest/)

</div>

## 📣 News
- **Fork of the [original, unmaintained repository](https://github.com/coqui-ai/TTS). New PyPI package: [SK-TTS](https://pypi.org/project/SK-TTS)**
...
| Type                            | Links                               |
| ------------------------------- | --------------------------------------- |
| 💼 **Documentation**              | [ReadTheDocs](https://SK-TTS.readthedocs.io/en/latest/)
